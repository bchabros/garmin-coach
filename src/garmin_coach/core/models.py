...
# The load blend replaces it with session-RPE. Single source of truth for the label.
...
def normalize_activity(p: dict[str, Any], weather: dict[str, Any] | None = None) -> dict[str, Any]:
