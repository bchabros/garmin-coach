"""Phase 10 recommender: a finished digest -> tomorrow's session recommendation.

Pure and read-only over the digest the Phase 3 engine already built. Turns the
...
def _rationale(
    ...
    aerobic_set_pace = (
        intended_type == "easy" and intensity_cap != "Z2" and pace is not None
    )
    cited: list[str] = []
